import { Button, Container, Font, Head, Html, Img, Text } from "@react-email/components";
...
const ratingStars = Array.from({ length: Math.floor(details.rating) }, (_, index) => (
  ...
  <Img src="http://localhost:8081/images/fullstar.png" style={{width:"70px",height:"70px"}} alt="fullstar"/>
));

if (details.rating % 1 !== 0) {
  // If there is a fractional part, add half star
  ratingStars.push(<Img src="http://localhost:8081/images/halfstar.png" style={{width:"70px",height:"70px"}} alt="halfstar"/>);
}

const emptyStars = Array.from({ length: Math.floor(5 - details.rating) }, (_, index) => (
  // Generate JSX for empty stars
  <Img src="http://localhost:8081/images/emptystar.png" style={{width:"70px",height:"70px"}} alt="emptystar"/>
));
  return (
    <Html style={{ backgroundColor: "white", textAlign: "center" }}>
      <Head>
        <Font
          fontFamily="Poppins"
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        <Img src="http://localhost:8081/images/logo.png" alt="logo" style={{ marginBottom: "115px", width:"200px",height:"73px" }} />
